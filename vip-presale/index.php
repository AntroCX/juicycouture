...
$APPLICATION->SetTitle("VIP Pre-Sale");

$file = 'articuls.csv';
$fp = fopen($_SERVER['DOCUMENT_ROOT'].$APPLICATION->GetCurDir().$file, 'r');
...
$GLOBALS["arCatalogFilter"]["PROPERTY_ARTNUMBER"] = array_unique($articuls);
