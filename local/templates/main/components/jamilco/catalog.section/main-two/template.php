...
?>
<script>
    var mainTwoItems = <?= Json::encode($arResult['JS_OBJ']['windowDataLayer']) ?>;
</script>
                    ...
                    <ul class="b-catalog__goods-item-wrapper-sku">
                        ...
                        <li class="b-catalog__goods-item-wrapper-sku-element <?if($firstSKU):?>active<?$firstSKU = false?><?endif?>" data-sku="<?=$arSKU['ID']?>">
                            ...
                            <div class="b-catalog__goods-item-wrapper-sku-element-wrapper">
                                ...
                                <a class="b-catalog__goods-item-link" href="<?=$arSKU['URL']?>" data-product-id="<?=$arItem['ID']?>"
                                   onclick="window.GENERAL.catalog.dataLayerClicks(this, mainTwoItems)"
                                ></a>
                                <?if($arSKU['VIDEO']):?>
                        ...
                        <li class="b-catalog__goods-item-wrapper-sku-element <?if($firstSKU):?>active<?$firstSKU = false?><?endif?>" data-sku="<?=$arSKU['ID']?>">
                            ...
                            <div class="b-catalog__goods-item-wrapper-sku-element-wrapper">
                                ...
                                <a class="b-catalog__goods-item-link" href="<?=$arSKU['URL']?>" data-product-id="<?=$arItem['ID']?>"
                                   onclick="window.GENERAL.catalog.dataLayerClicks(this, mainTwoItems)"
                                ></a>
                                <a data-href="<?=$arSKU['URL']?>" class="b-catalog__goods-item-quick hidden-xs hidden-sm" data-product-id="<?=$arItem['ID']?>"
                                   onclick="window.GENERAL.catalog.dataLayerClicks(this, mainTwoItems)"
                                >Быстрый просмотр</a>
                                <?if($arSKU['VIDEO']):?>
                                    <a href="#video" class="b-catalog__goods-item-video">Видео</a>
