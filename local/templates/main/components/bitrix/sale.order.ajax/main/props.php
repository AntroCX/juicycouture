...
<div class="bx_section">
	<div class="b-order__block-message text-right">
	...
	<div id="sale_order_props">
		<div class="b-order__props-user">
			<div class="row">
		<?
		PrintPropsForm($arResult['ORDER_PROP']['USER_PROPS'], $arParams["TEMPLATE_LOCATION"]);
        printLocationProp($arResult['ORDER_PROP']['LOCATION']);
        PrintTabletProp($arResult['TABLET']); // табельный номер
		?>
			</div>
		</div>
	</div>
