	...
	<div class="b-catalog__content">
		<div class="row">
			...
			<div class="col-md-12 b-page__loader-wrapper">
                <div class="bf-banner">
                    <?$APPLICATION->IncludeFile(SITE_DIR . ".inc/catalog/blackfriday.php", array(), array("MODE"=>"html", "NAME" => "Баннер ЧП", "TEMPLATE" => "standard_inc.php"));?>
                </div>
                ...
                $cityStoreName = \Jamilco\Main\Retail::getItemFilter($GLOBALS[$arParams['FILTER_NAME']], true);
                ...
                if($_REQUEST["BRAND"]){
                    ...
                    {
                        $arBrands[$enum_fields["XML_ID"]] = array(
                            "ID" => $enum_fields["ID"],
                            "XML_ID" => $enum_fields["XML_ID"],
                            "VALUE" => $enum_fields["VALUE"],
                        );
                    }
                    if(in_array($_REQUEST["BRAND"], array_column($arBrands, 'XML_ID'))) {
                        $GLOBALS[$arParams['FILTER_NAME']]['PROPERTY_BRAND'] =  $arBrands[$_REQUEST["BRAND"]]["ID"];
                        $BRAND_NAME = $arBrands[$_REQUEST["BRAND"]]["VALUE"];
                        $APPLICATION->AddChainItem($BRAND_NAME, "");
                    }
                }
...
// Adspire
\Adspire\Manager::getInstance()->setContainerElement(['push' => ['TypeOfPage' => 'sales']], true);
?>
