...
class Version20220823143650 extends Version
{
  ...
  'IBLOCK_TYPE_ID' => 'periodic_content',
  'LID' => 
  array (
    0 => 's1',
  ),
  ...
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'LIST_PAGE_URL' => '#SITE_DIR#/periodic_content/index.php?ID=#IBLOCK_ID#',
  'DETAIL_PAGE_URL' => '#SITE_DIR#/periodic_content/detail.php?ID=#ELEMENT_ID#',
  'SECTION_PAGE_URL' => '#SITE_DIR#/periodic_content/list.php?SECTION_ID=#SECTION_ID#',
  'CANONICAL_PAGE_URL' => '',
  'PICTURE' => NULL,
  'DESCRIPTION' => '',
  ...
  'NAME' => 'для плашета (ширина 1200px)',
  'ACTIVE' => 'Y',
  'SORT' => '50',
  'CODE' => 'TABLET',
  'DEFAULT_VALUE' => '',
  ...
  'HINT' => '',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'для смартфона (ширина 720px)',
  'ACTIVE' => 'Y',
  'SORT' => '80',
  'CODE' => 'MOBILE',
  'DEFAULT_VALUE' => '',
  ...
  array (
    ...
    'PREVIEW_PICTURE' => 'для ПК (ширина > 1200)',
    'PROPERTY_TABLET' => 'для плашета (ширина 1200px)',
    'PROPERTY_MOBILE' => 'для смартфона (ширина 720px)',
    'PROPERTY_HREF' => 'Ссылка',
    'PROPERTY_BUTTONS' => 'Кнопка и ссылка',
    'PROPERTY_BUTTON_COLOR' => 'Цвет кнопки',
    'PROPERTY_BUTTON_TEXT_COLOR' => 'Цвет текста кнопки',
    'PROPERTY_TITLE_TEXT' => 'Текст заголовка',
    'PROPERTY_TITLE_COLOR' => 'Цвет заголовка',
    'PROPERTY_SUBTITLE_TEXT' => 'Текст подзаголовка',
    'PROPERTY_SUBTITLE_COLOR' => 'Цвет подзаголовка',
  ),
  'Анонс|edit5' => 
  array (
